...
const translations = {
  tr: {
    // Navigation / Sidebar
    "nav.app_name": "AkıllıÖlçüm",
    "nav.dashboard": "Ana Panel",
    "nav.measurement": "Akıllı Ölçüm",
    "nav.visual_placement": "Görsel Yerleştirme",
    "nav.settings": "Ayarlar",
    "nav.my_account": "Hesabım",
    "nav.logout": "Çıkış Yap",
    "nav.checking_session": "Oturum kontrol ediliyor...",
    "nav.light_mode": "Açık Mod",
    "nav.dark_mode": "Koyu Mod",
    // Settings page
  ...
  en: {
    // Navigation / Sidebar
    "nav.app_name": "SmartMeasure",
    "nav.dashboard": "Dashboard",
    "nav.measurement": "Smart Measurement",
    "nav.visual_placement": "Visual Placement",
